...
cyprus.initialize()  # initialize the RPiMIB and establish communication
cyprus.setup_servo(1)  # sets up P5 on the RPiMIB as a RC servo motor controller style output
...
for i in range(5, 10, 1):
    cyprus.set_servo_position(1, i/10.0)  # 2 specifies port P5, i is a float that specifies speed
    sleep(0.5)
...
cyprus.set_pwm_values(1, period_value=100000, compare_value=0, compare_mode=cyprus.LESS_THAN_OR_EQUAL) #  Motor OFF
cyprus.close()
